...
<p align="center">
  <a href="https://devtools.at/tools/image-to-base64"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Convert images to Base64</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/image-to-base64">Try Online</a> •
...
**[Try Image to Base64 online at DevTools.at →](https://devtools.at/tools/image-to-base64)**
...
Convert images to Base64. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/image-to-base64';
